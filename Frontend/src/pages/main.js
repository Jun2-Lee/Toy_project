    ...
    <div className='main_container'>
      ...
      <Link to="/sharing" className='main_link'>
        <button className='main_sharingBtn'>
          ...
          <img className='main_pagemoving_img' id='sharingPicture' src='assets/img/sharing.png'></img>
        </button>
      </Link>
      <Link to="/dutchpay" className='main_link'>
        <button className='main_dutchPayBtn'>
          ...
          <img className='main_pagemoving_img' id='dutchPayPicture' src='assets/img/dutchpay.png'></img>
        </button>
      </Link>
      <Link to="/groupbuying" className='main_link'>
        <button className='main_groupBuyingBtn'>
          ...
          <img className='main_pagemoving_img' id='groupBuyingPicture' src='assets/img/groupBuying.png'></img>
        </button>
      </Link>
    </div>
  )
